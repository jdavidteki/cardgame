  ...
  render() {
    ...
    return (
      <div className="Header">
          <div style={{ fontWeight: 900 }}>cardgame</div>
          <div className="right-part">
            {!this.props.someoneLoggedIn ? (
              <Button
                ...
                color="primary"
                onClick={() => {
                  this.props.history.push("/cardgame/login");
                }}
              >
                Log in
              </Button>
                ...
                <Avatar
                  ...
                  src={`https://firebasestorage.googleapis.com/v0/b/cardgame-ff8d1.appspot.com/o/images%2F${this.props.loggedInUser.uid}.jpeg?alt=media&token=86d4ac39-d703-416a-a257-f209a64b0cb4`}
                >
                  <Person />
                </Avatar>
            )}
            ...
            >
              ...
              <MenuItem
                onClick={() => {
                  this.setState({ anchorEl: null });
                  this.props.history.push("/cardgame/appointments");
                }}
              >
                Appointments
              </MenuItem>
              { this.props.someoneLoggedIn ?
                (
                  <MenuItem
                    onClick={() => {
                      this.setState({ anchorEl: null });
                      this.props.history.push("/cardgame/profile");
                    }}
                  >
